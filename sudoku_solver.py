...
def only_choice(values):
    ...
    """
    for unit in unitlist:  # Only choice strategy, which strategy 2 to solve Sudoku
...
def search(values):      
    # Depth-First (Uninformed) Search Alogirhtm  
    ...
    # Using recurrence to solve each one of the resulting sudokus
